$(function () {
    ...
    var data = {
        rss: 'https://medium.com/feed/@gunjan-dhanuka'
    };
    $.get(' https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fmedium.com%2Ffeed%2F%40gunjan-dhanuka', data, function (response) {
        if (response.status == 'ok') {
            ...
            $.each(response.items, function (k, item) {
                ...
                display += `<img src="${src}" class="card-img-top" alt="Cover image" width="150>`;
